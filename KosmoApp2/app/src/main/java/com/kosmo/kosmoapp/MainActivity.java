...
import com.kosmo.kosmoapp.view.Fragment_1;
import com.kosmo.kosmoapp.view.Fragment_2;
import com.kosmo.kosmoapp.view.Fragment_3;
import com.kosmo.kosmoapp.view.Fragment_4;
import com.kosmo.kosmoapp.view.MyPagerAdapter;
...
//        tabLayout.addTab(tabLayout.newTab().setCustomView(CustomTabview("웹뷰",R.drawable.perm_group_device_alarms)));
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if(tab.getPosition()==2){// 카메라  tab 눌렀을때만 권한 요청
                    //권한 요청]
                    //3]권한 요청하기
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        if(tabCurrentIndex ==0){//PICASSO tab인 경우 어플리케이션 종료 묻기
